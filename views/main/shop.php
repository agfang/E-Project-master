  ...
  <div class="container">
    ...
    <div class="row">
      <?php 
        // switch($category){
        //   case 'Vegetables':
        //     $sql="SELECT * FROM products WHERE Category = 'Vegetables' LIMIT $start, $limit"; 
        //     break;
        //   case 'Fruits':
        //     $sql="SELECT * FROM products WHERE Category = 'Fruits' LIMIT $start, $limit"; 
        //     break;
        //   case 'Juice':
        //     $sql="SELECT * FROM products WHERE Category = 'Juice' LIMIT $start, $limit"; 
        //     break;
        //   case 'Dried':
        //     $sql="SELECT * FROM products WHERE Category = 'Dried' LIMIT $start, $limit"; 
        //     break;
        //   default:
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="product">
            ...
            <a class="img-prod" href="#">
              <img class="img-fluid" src="../../templates/main/<?php echo $row['Image'] ?>" alt="Colorlib Template">
