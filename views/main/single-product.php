    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="../../templates/main/<?php echo $row['Image'] ?>" class="image-popup"><img src="../../templates/main/<?php echo $row['Image'] ?>" class="img-fluid" alt="Colorlib Template"></a>
            </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        ...
                        <a class="img-prod" href="#">
                            <img class="img-fluid" src="../../templates/main/<?php echo $row_s['Image'] ?>" alt="Colorlib Template">
